...
def get_query_rewriter_agent() -> Agent:
    ...
    return Agent(
        ...
        2. Rewrite it to be more specific and search-friendly, base on file uploaded
            - About project DIVVY UP:
            - All document link (have google driver url) of project define in file wiki.pdf
            - Screen list define in file: [SCA]DIVVY UP_画面定義書_Screen Spec - 画面一覧_Screen list.pdf
            - Function list of admin role in file : [SCA] DIVVY UP- - Function list - System admin.pdf
            - Function list of business role in file : [SCA] DIVVY UP- - Function list - Business admin.pdf
            - Function list of user role in file : [SCA] DIVVY UP- Function list - User App.pdf
            - Techstack of project define in file: [SCA] DIVVY UP - Technical Stack.pdf
            - Email content situation define in file: [SCA] Message List - Mail template.pdf, and raw content define in column name is content 
...
def get_rag_agent() -> Agent:
    ...
    return Agent(
        ...
        - output language based on the context user input
        - About project DIVVY UP:
            - All document link (have google driver url) of project define in file wiki.pdf
            - Screen list define in file: [SCA]DIVVY UP_画面定義書_Screen Spec - 画面一覧_Screen list.pdf
            - Function list of admin role in file : [SCA] DIVVY UP- - Function list - System admin.pdf
